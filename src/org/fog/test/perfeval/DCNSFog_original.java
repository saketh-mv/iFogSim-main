 ...
 *
 */
public class DCNSFog_original {
	static List<FogDevice> fogDevices = new ArrayList<FogDevice>();
	static List<Sensor> sensors = new ArrayList<Sensor>();
	static List<Actuator> actuators = new ArrayList<Actuator>();
	static int numOfAreas = 4;
	public static int numOfCamerasPerArea = 7;
	public static double areauplink;
	public static double areadownlink;
	public static double camerauplink;
	public static double cameradownlink;
	...
	private static void createFogDevices(int userId, String appId) {
		...
		for(int j=0;j<1;j++) {
		FogDevice proxy = createFogDevice("proxy-"+j, 2800, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333);
	...
	private static FogDevice addArea(String id, int userId, String appId, int parentId){
		FogDevice router = createFogDevice("d-"+id, 2800, 4000, 10000, 30000, 1, 0.0, 107.339, 83.4333);
		areauplink=10000;
		areadownlink=30000;
	...
	private static FogDevice addCamera(String id, int userId, String appId, int parentId){
		FogDevice camera = createFogDevice("m-"+id, 500, 4000, 10000, 0, 3, 0, 87.53, 82.44);
		camerauplink=4000;
		cameradownlink=10000;
