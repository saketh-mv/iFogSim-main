...
public class VRGameFog {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * Both are almost simliar but running the 2nd one is causing error
			 */
...
*/				moduleMapping.addModuleToDevice("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
	...
	private static Application createApplication(String appId, int userId){
		 ...
		 * Both are same we can write in any way
		 */
		/*
		...
		/*The above expression can also be written in other way
