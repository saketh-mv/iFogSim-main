...
import org.fog.test.perfeval.DCNSFogmorenodes;
...
public class FogDevice extends PowerDatacenter {
    ...
    private static ArrayList<Double> energy=new ArrayList<Double>();
    private static double[] allenergy=new double[30];
    private static int totalnodes1;
    ...
    public FogDevice(
        ...
        //System.out.println(downlinkBandwidth+"  " +name);
    ...
    private void updateEnergyConsumption() {
        ...
        //System.out.println(newEnergyConsumption+"       "+(timeNow - lastUtilizationUpdateTime) +"     jjw  "+getHost().getPowerModel().getPower(lastUtilization)+"      dcs  "+currentEnergyConsumption+"    "+l);
        setEnergyConsumption(newEnergyConsumption);
        totalnodes1=DCNSFogmorenodes.getnodes();
        for(int i=0;i<totalnodes1;i++) {
        	String s="d-"+i;
        	if(getName().equals(s)) {
        		allenergy[i]=newEnergyConsumption;
        	}
        }
        if(getName().equals("m-0-0")) {
        	Calendar cal1=Calendar.getInstance();
        	l1=l1+ (cal1.getTimeInMillis()-cal.getTimeInMillis());
        	if((cal1.getTimeInMillis()-cal.getTimeInMillis())!=0) {
        		System.out.println(l+"  "+l1+"  "+ cal1.getTimeInMillis()+"   "+cal.getTimeInMillis());
        	}
        }
		if(getName().equals("d-5")){
			/*System.out.println("------------------------");
			System.out.println("Utilization = "+lastUtilization);
			System.out.println("Power = "+getHost().getPowerModel().getPower(lastUtilization));
			System.out.println("Energy consumption= "+newEnergyConsumption);
			System.out.println(timeNow-lastUtilizationUpdateTime);*/
			energy.add(newEnergyConsumption);
		}
    ...
    protected double coordinatevalue;
	protected double coordinatevalue2;
	public void setxCoordinate(double coordinatevalue3) {
		this.coordinatevalue=coordinatevalue3;
	}
	public double getxCoordinate()
	{
	return coordinatevalue;
	}
	public void setyCoordinate(double coordinatevalue4) {
		this.coordinatevalue2=coordinatevalue4;
	}
	public double getyCoordinate()
	{
	return coordinatevalue2;
	}

	public static ArrayList<Double> getenergy() {
		// TODO Auto-generated method stub
		return energy;
	}

	public static double[] getenergies() {
		// TODO Auto-generated method stub
		return allenergy;
	}
