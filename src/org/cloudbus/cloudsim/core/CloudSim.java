...
public class CloudSim {
	...
	public static void init(int numUser, Calendar cal, boolean traceFlag) {
		try {
			...
			System.out.println("CloudSim.init(): The simulation has been terminated due to an unexpected error");
	 ...
	 * @post $none
	 */
	public static double startSimulation() throws NullPointerException, RejectedExecutionException, EngineException, InterruptedException, ExecutionException {
	 ...
	 * @throws RejectedExecutionException 
	 */
	public static boolean runClockTick() throws RejectedExecutionException, EngineException, InterruptedException, ExecutionException {
		SimEntity ent;
		boolean queue_empty;
	 ...
	 */
	public static void runStop1() {
		printMessage("Simulation completed.1");
	}
	 ...
	 * @throws RejectedExecutionException 
	 */
	public static double run() throws RejectedExecutionException, EngineException, InterruptedException, ExecutionException {
		if (!running) {
			runStart();
		}
		while (true) {
	 ...
	 * @throws RejectedExecutionException 
	 */
	public static void finishSimulation() throws RejectedExecutionException, EngineException, InterruptedException, ExecutionException {
