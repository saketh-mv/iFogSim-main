...
public abstract class SimEntity implements Cloneable {
	 ...
	 */
	public abstract void processEvent(SimEvent ev) throws RejectedExecutionException, EngineException, InterruptedException, ExecutionException;
	...
	public void run() throws RejectedExecutionException, EngineException, InterruptedException, ExecutionException {
